    ...
    <div class="main main-raised">
      <div class="section profile-content">
        <div class="container">
          <div class="md-layout">
            <div
              class="md-layout-item md-white md-size-100 md-small-size-100 md-xsmall-size-100 md-medium-size-100 mx-auto"
            >
              ...
              <p class="description">
                Please input follow information to create your own Event!
              </p>
            </div>
            ...
            >
              <md-field class="md-form-group md-green" slot="inputs">
                ...
                <span class="md-helper-text"
                  >Please input the shot description of your event</span
                >
              </md-field>
            </div>
            <div
            ...
            >
              <md-field class="md-form-group md-green" slot="inputs">
                ...
                <md-input
                  v-model="event.maxnumber"
                  placeholder="PARTICIPANTS LIMIT"
                ></md-input>
                <span class="md-helper-text"
                  >Please input the number of participants</span
                >
              </md-field>
            </div>
            ...
            <div
              class="md-layout-item md-white md-size-100 md-small-size-100 md-xsmall-size-100 md-medium-size-100 mx-auto"
            >
              <md-checkbox slot="inputs" v-model="event.perferences" value="1"
                >Game</md-checkbox
              >
              <md-checkbox slot="inputs" v-model="event.perferences" value="2"
                >Spots</md-checkbox
              >
              <md-checkbox slot="inputs" v-model="event.perferences" value="3"
                >Travel</md-checkbox
              >
              <md-checkbox slot="inputs" v-model="event.perferences" value="4"
                >Hiking</md-checkbox
              >
              <md-checkbox slot="inputs" v-model="event.perferences" value="5"
                >Movie</md-checkbox
              >
              <md-checkbox slot="inputs" v-model="event.perferences" value="6"
                >Reading</md-checkbox
              >
            ...
            <div
              class="md-layout-item md-white md-size-50 md-small-size-100 md-xsmall-size-100 md-medium-size-50 mx-auto"
            >
            ...
            <div
              class="md-layout-item md-white md-size-100 md-small-size-100 md-xsmall-size-100 md-medium-size-50 mx-auto"
            >
              <div class="space-50"></div>
              <el-upload
                :show-file-list="true"
            ...
            <div
              class="md-layout-item md-white md-size-20 md-small-size-20 md-xsmall-size-30 md-medium-size-20 mx-auto"
            >
              <div class="space-50"></div>
              <md-button
                class="md-primary md-block md-success"
                @click="createEvent"
              >
                Submit
              </md-button>
